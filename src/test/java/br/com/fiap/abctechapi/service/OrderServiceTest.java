...
public class OrderServiceTest {
    ...
    public void init(){
        ...
        when(assistRepository.findById(any())).thenReturn(Optional.of(new Assist(1L, "Teste","Description Test")));
    }
    @Test
    ...
    @Test
    public void create_order_error_max() throws Exception{
        Order newOrder = new Order();
        newOrder.setOperatorId(1234L);

        Assertions.assertThrows(MaxAssistsException.class, () -> orderService.saveOrder(newOrder, List.of(1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L, 12L, 13L, 14L, 15L, 16L, 17L)));
        verify(orderRepository, times(0)).save(newOrder);
    }
